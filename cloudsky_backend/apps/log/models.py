...
class ApiLog(models.Model):
    ...
    param = models.TextField(verbose_name="请求参数", max_length=5000, null=True, blank=True)
    comment = models.CharField(verbose_name="备注", max_length=255, null=True, blank=True)
    time = models.BigIntegerField(verbose_name="执行时长(毫秒)")
    ip = models.CharField(verbose_name="IP地址", max_length=64)
    create_time = models.DateTimeField(verbose_name="创建时间", auto_now_add=True)
    username = models.CharField(verbose_name="访问用户名", max_length=30)
